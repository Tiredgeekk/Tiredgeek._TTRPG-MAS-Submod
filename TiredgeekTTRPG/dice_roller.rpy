...
label hv_dice_roller:
    ...
    menu:
        "D4":
            $ diceType = 4
            "A D4! Those are tiny but sneaky… perfect for little surprises, ehehe~"
            jump ask_num_dice
        "D6":
            $ diceType = 6
            "D6s! Classic and reliable… like a little rhythm to your adventures~"
            jump ask_num_dice
        "D8":
            $ diceType = 8
            "Ooh, D8s! They’re elegant and a bit unpredictable… I like that~"
            jump ask_num_dice
        "D10":
            $ diceType = 10
            "A D10! Perfect for rolling percentages or big choices… so exciting!"
            jump ask_num_dice
        "D12":
            $ diceType = 12
            "D12s are strong and powerful… they feel epic, don’t they? Ehehe~"
            jump ask_num_dice
        "D20":
            $ diceType = 20
            "Ah, the famous D20! Heroes’ fate lies in these rolls… I hope you get some lucky ones~"
            jump ask_num_dice
        "D100":
            $ diceType = 100
            "Whoa, D100! That’s huge… I can’t wait to see what crazy numbers we get, ehehe~"
            jump ask_num_dice

label ask_num_dice:

    "How many of these should I roll for you?"
    ...
    menu:
        ...
        "Choose a different dice":
            jump hv_dice_roller
        "That’s it for now":
            "Okay! I had so much fun rolling with you~ I hope your next rolls are lucky too!"
            return
